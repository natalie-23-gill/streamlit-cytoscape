...
class TestStCytoscapeFunction:
    ...
    def test_st_cytoscape_with_styles(
        self, mock_component, sample_elements, sample_node_style, sample_edge_style
    ):
    ...
    def test_st_cytoscape_with_highlight_style(
        self, mock_component, sample_elements, sample_highlight_style
    ):
        """Test st_cytoscape with highlight style"""
        mock_component.return_value = None

        st_cytoscape(elements=sample_elements, highlight_style=sample_highlight_style)
    ...
    def test_st_cytoscape_without_highlight_style(
        self, mock_component, sample_elements
    ):
    ...
    def test_st_cytoscape_position_from_node_style(self, mock_component):
        ...
        elements = [{"data": {"id": "n1", "label": "Node 1", "type": "person"}}]

        node_style = NodeStyle(
            type="person", color="#3498db", position={"x": 150.0, "y": 250.0}
        )
    ...
    def test_st_cytoscape_custom_dimensions(self, mock_component, sample_elements):
        ...
        st_cytoscape(elements=sample_elements, height=800, width="80%")
    ...
    def test_st_cytoscape_empty_styles(self, mock_component, sample_elements):
        ...
        st_cytoscape(elements=sample_elements, node_styles=None, edge_styles=None)
    ...
    def test_st_cytoscape_edge_elements(self, mock_component):
        ...
        elements = [
            ...
            {"data": {"id": "e1", "source": "n1", "target": "n2", "type": "connects"}},
        ]
